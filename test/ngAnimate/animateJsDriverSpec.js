...
ddescribe("ngAnimate $$animateJsDriver", function() {
  ...
  it('should return nothing if no animations are registered at all', inject(function($$animateJsDriver) {
    var element = jqLite('<div></div>');
    expect($$animateJsDriver(element, 'enter')).toBeFalsy();
  }));
  ...
  it('should return nothing if no matching animations classes are found', function() {
    ...
    inject(function($$animateJsDriver) {
  ...
  it('should return nothing if a matching animation class is found, but not a matching event', function() {
    ...
    inject(function($$animateJsDriver) {
      ...
      expect($$animateJsDriver(element, 'leave')).toBeFalsy();
    });
  });
  ...
  it('should return a truthy value if a matching animation class and event are found', function() {
    ...
    inject(function($$animateJsDriver) {
      var element = jqLite('<div class="foo"></div>');
      expect($$animateJsDriver(element, 'enter')).toBeTruthy();
    });
  });
  ...
  it('should strictly query for the animation based on the classes value if passed in', function() {
    ...
    inject(function($$animateJsDriver) {
      ...
      expect($$animateJsDriver(element, 'enter', 'superman')).toBeTruthy();
      expect($$animateJsDriver(element, 'leave', 'legoman batman')).toBeTruthy();
      expect($$animateJsDriver(element, 'enter', 'legoman')).toBeFalsy();
    });
  });
  ...
  describe("events", function() {
    ...
    beforeEach(module(function($animationProvider) {
      ...
      return function($$animateJsDriver) {
        runAnimation = function(method, done, error, options) {
          var driver = $$animateJsDriver(element, method, 'test-animation')({
            options: options,
