...
xdescribe("ngAnimate", function() {
  ...
  //we use another xdescribe block because the before/after operations below
  //are used across all animations tests and we don't want that same behavior
  //to be used on the root xdescribe block at the start of the animateSpec.js file
  xdescribe('', function() {
    ...
    xdescribe("$animate", function() {
      ...
      xdescribe("enable / disable", function() {
      ...
      xdescribe("with polyfill", function() {
      ...
      xdescribe("with CSS3", function() {
        ...
        xdescribe("Transitions", function() {
      ...
      xdescribe('animation evaluation', function() {
      ...
      xdescribe("addClass / removeClass", function() {
  ...
  //  });
    ...
    xdescribe('ngAnimateChildren', function() {
      var spy;
  ...
  xdescribe('CSS class DOM manipulation', function() {
    var element;
    var addClass;
    var removeClass;
